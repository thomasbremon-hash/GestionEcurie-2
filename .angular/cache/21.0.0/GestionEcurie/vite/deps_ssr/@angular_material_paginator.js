...
} from "./chunk-ZTLQCHG4.js";
import {
  BidiModule,
  Directionality
} from "./chunk-U6HLQY4N.js";
import {
  FormGroupDirective,
  NgControl,
  NgForm,
...
var FixedSizeVirtualScrollStrategy = class {
  ...
  scrolledIndexChange = this._scrolledIndexChange.pipe((0, import_operators3.distinctUntilChanged)());
  _viewport = null;
  _itemSize;
  _minBufferPx;
  _maxBufferPx;
...
var ScrollDispatcher = class _ScrollDispatcher {
  ...
  ancestorScrolled(elementOrElementRef, auditTimeInMs) {
    ...
    return this.scrolled(auditTimeInMs).pipe((0, import_operators3.filter)((target) => !target || ancestors.indexOf(target) > -1));
  }
...
var CdkVirtualScrollViewport = class _CdkVirtualScrollViewport extends CdkVirtualScrollable {
  ...
  ngOnInit() {
    ...
    this.ngZone.runOutsideAngular(() => Promise.resolve().then(() => {
      ...
      this.scrollable.elementScrolled().pipe((0, import_operators3.startWith)(null), (0, import_operators3.auditTime)(0, SCROLL_SCHEDULER), (0, import_operators3.takeUntil)(this._destroyed)).subscribe(() => this._scrollStrategy.onContentScrolled());
...
var CdkVirtualForOf = class _CdkVirtualForOf {
  ...
  dataStream = this._dataSourceChanges.pipe((0, import_operators3.startWith)(null), (0, import_operators3.pairwise)(), (0, import_operators3.switchMap)(([prev, cur]) => this._changeDataSource(prev, cur)), (0, import_operators3.shareReplay)(1));
  _differ = null;
  _data;
  _renderedItems;
  _renderedRange;
...
var SelectionModel = class {
  ...
  changed = new import_rxjs9.Subject();
...
var MatSelect = class _MatSelect {
  ...
  _animationsDisabled = _animationsDisabled();
  _initialized = new import_rxjs12.Subject();
  _cleanupDetach;
  options;
  optionGroups;
  customTrigger;
  ...
  _previousControl;
  _destroy = new import_rxjs12.Subject();
  _errorStateTracker;
  stateChanges = new import_rxjs12.Subject();
  ...
  optionSelectionChanges = (0, import_rxjs12.defer)(() => {
    const options = this.options;
    if (options) {
      return options.changes.pipe((0, import_operators7.startWith)(options), (0, import_operators7.switchMap)(() => (0, import_rxjs12.merge)(...options.map((option) => option.onSelectionChange))));
    }
    return this._initialized.pipe((0, import_operators7.switchMap)(() => this.optionSelectionChanges));
  });
  openedChange = new EventEmitter();
  _openedStream = this.openedChange.pipe((0, import_operators7.filter)((o) => o), (0, import_operators7.map)(() => {
  }));
  _closedStream = this.openedChange.pipe((0, import_operators7.filter)((o) => !o), (0, import_operators7.map)(() => {
  }));
  ...
  ngOnInit() {
    ...
    this.stateChanges.next();
    this._viewportRuler.change().pipe((0, import_operators7.takeUntil)(this._destroy)).subscribe(() => {
      if (this.panelOpen) {
  ...
  ngAfterContentInit() {
    ...
    this._selectionModel.changed.pipe((0, import_operators7.takeUntil)(this._destroy)).subscribe((event) => {
      event.added.forEach((option) => option.select());
      event.removed.forEach((option) => option.deselect());
    });
    this.options.changes.pipe((0, import_operators7.startWith)(null), (0, import_operators7.takeUntil)(this._destroy)).subscribe(() => {
      this._resetOptions();
      this._initializeSelection();
    });
  }
  ...
  open() {
    ...
    this._overlayDir.positionChange.pipe((0, import_operators7.take)(1)).subscribe(() => {
      this._changeDetectorRef.detectChanges();
  ...
  _resetOptions() {
    const changedOrDestroyed = (0, import_rxjs12.merge)(this.options.changes, this._destroy);
    this.optionSelectionChanges.pipe((0, import_operators7.takeUntil)(changedOrDestroyed)).subscribe((event) => {
    ...
    (0, import_rxjs12.merge)(...this.options.map((option) => option._stateChanges)).pipe((0, import_operators7.takeUntil)(changedOrDestroyed)).subscribe(() => {
      this._changeDetectorRef.detectChanges();
      this.stateChanges.next();
    });
  }
...
var MatTooltip = class _MatTooltip {
  ...
  _destroyed = new import_rxjs13.Subject();
  _isDestroyed = false;
  constructor() {
  ...
  ngAfterViewInit() {
    ...
    this._setupPointerEnterEventsIfNeeded();
    this._focusMonitor.monitor(this._elementRef).pipe((0, import_operators8.takeUntil)(this._destroyed)).subscribe((origin) => {
      if (!origin) {
  ...
  show(delay = this.showDelay, origin) {
    ...
    instance.afterHidden().pipe((0, import_operators8.takeUntil)(this._destroyed)).subscribe(() => this._detach());
    this._setTooltipClass(this._tooltipClass);
    this._updateTooltipMessage();
    instance.show(delay);
  }
  ...
  _createOverlay(origin) {
    ...
    strategy.positionChanges.pipe((0, import_operators8.takeUntil)(this._destroyed)).subscribe((change) => {
    ...
    this._updatePosition(this._overlayRef);
    this._overlayRef.detachments().pipe((0, import_operators8.takeUntil)(this._destroyed)).subscribe(() => this._detach());
    this._overlayRef.outsidePointerEvents().pipe((0, import_operators8.takeUntil)(this._destroyed)).subscribe(() => this._tooltipInstance?._handleBodyInteraction());
    this._overlayRef.keydownEvents().pipe((0, import_operators8.takeUntil)(this._destroyed)).subscribe((event) => {
    ...
    if (!this._dirSubscribed) {
      ...
      this._dir.change.pipe((0, import_operators8.takeUntil)(this._destroyed)).subscribe(() => {
        if (this._overlayRef) {
          this._updatePosition(this._overlayRef);
        }
      });
...
var TooltipComponent = class _TooltipComponent {
  ...
  _isVisible = false;
  _onHide = new import_rxjs13.Subject();
...
var MatPaginatorIntl = class _MatPaginatorIntl {
  changes = new import_rxjs15.Subject();
...
var MatPaginator = class _MatPaginator {
  ...
  _intlChanges;
  _isInitialized = false;
  _initializedStream = new import_rxjs15.ReplaySubject(1);
  color;
  get pageIndex() {
